...
void setup_scr_screen(lv_ui *ui)
{
    ...
    //Write codes screen_cont_list
    ui->screen_cont_list = lv_obj_create(ui->screen);
    lv_obj_set_pos(ui->screen_cont_list, 0, 19);
    lv_obj_set_size(ui->screen_cont_list, 800, 460);
    lv_obj_set_scrollbar_mode(ui->screen_cont_list, LV_SCROLLBAR_MODE_OFF);

    //Write style for screen_cont_list, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->screen_cont_list, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_cont_list, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->screen_cont_list, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_cont_list, lv_color_hex(0x343247), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->screen_cont_list, LV_GRAD_DIR_VER, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_color(ui->screen_cont_list, lv_color_hex(0x343247), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_main_stop(ui->screen_cont_list, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_stop(ui->screen_cont_list, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->screen_cont_list, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->screen_cont_list, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->screen_cont_list, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->screen_cont_list, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_cont_list, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_label_time_8
    ui->screen_label_time_8 = lv_label_create(ui->screen_cont_list);
    ...
    ui->screen_label_time_7 = lv_label_create(ui->screen_cont_list);
    ...
    ui->screen_label_time_6 = lv_label_create(ui->screen_cont_list);
    ...
    ui->screen_label_time_5 = lv_label_create(ui->screen_cont_list);
    ...
    ui->screen_label_time_4 = lv_label_create(ui->screen_cont_list);
    ...
    ui->screen_label_time_3 = lv_label_create(ui->screen_cont_list);
    ...
    ui->screen_label_time_2 = lv_label_create(ui->screen_cont_list);
    ...
    ui->screen_label_time_1 = lv_label_create(ui->screen_cont_list);
    ...
    ui->screen_label_author_8 = lv_label_create(ui->screen_cont_list);
    ...
    ui->screen_label_author_7 = lv_label_create(ui->screen_cont_list);
    ...
    ui->screen_label_author_6 = lv_label_create(ui->screen_cont_list);
    ...
    ui->screen_label_author_5 = lv_label_create(ui->screen_cont_list);
    ...
    ui->screen_label_author_4 = lv_label_create(ui->screen_cont_list);
    ...
    ui->screen_label_author_3 = lv_label_create(ui->screen_cont_list);
    ...
    ui->screen_label_author_2 = lv_label_create(ui->screen_cont_list);
    ...
    ui->screen_label_music_8 = lv_label_create(ui->screen_cont_list);
    ...
    ui->screen_label_music_7 = lv_label_create(ui->screen_cont_list);
    ...
    ui->screen_label_music_6 = lv_label_create(ui->screen_cont_list);
    ...
    ui->screen_label_music_5 = lv_label_create(ui->screen_cont_list);
    ...
    ui->screen_label_music_4 = lv_label_create(ui->screen_cont_list);
    ...
    ui->screen_label_music_3 = lv_label_create(ui->screen_cont_list);
    ...
    ui->screen_label_music_2 = lv_label_create(ui->screen_cont_list);
    ...
    ui->screen_img_8 = lv_image_create(ui->screen_cont_list);
    ...
    lv_image_set_src(ui->screen_img_8, &_btn_list_play_RGB565A8_70x70);
    lv_image_set_pivot(ui->screen_img_8, 0,0);
    ...
    ui->screen_img_7 = lv_image_create(ui->screen_cont_list);
    ...
    lv_image_set_src(ui->screen_img_7, &_btn_play_RGB565A8_70x70);
    lv_image_set_pivot(ui->screen_img_7, 0,0);
    ...
    ui->screen_img_6 = lv_image_create(ui->screen_cont_list);
    ...
    lv_image_set_src(ui->screen_img_6, &_btn_list_play_RGB565A8_70x70);
    lv_image_set_pivot(ui->screen_img_6, 0,0);
    ...
    ui->screen_img_5 = lv_image_create(ui->screen_cont_list);
    ...
    lv_image_set_src(ui->screen_img_5, &_btn_list_play_RGB565A8_70x70);
    lv_image_set_pivot(ui->screen_img_5, 0,0);
    ...
    ui->screen_img_4 = lv_image_create(ui->screen_cont_list);
    ...
    lv_image_set_src(ui->screen_img_4, &_btn_list_play_RGB565A8_70x70);
    lv_image_set_pivot(ui->screen_img_4, 0,0);
    ...
    ui->screen_img_3 = lv_image_create(ui->screen_cont_list);
    lv_obj_set_pos(ui->screen_img_3, 0, 139);
    lv_obj_set_size(ui->screen_img_3, 70, 70);
    lv_obj_add_flag(ui->screen_img_3, LV_OBJ_FLAG_CLICKABLE);
    lv_image_set_src(ui->screen_img_3, &_btn_list_play_RGB565A8_70x70);
    lv_image_set_pivot(ui->screen_img_3, 0,0);
    ...
    ui->screen_img_2 = lv_image_create(ui->screen_cont_list);
    lv_obj_set_pos(ui->screen_img_2, 0, 77);
    lv_obj_set_size(ui->screen_img_2, 70, 70);
    lv_obj_add_flag(ui->screen_img_2, LV_OBJ_FLAG_CLICKABLE);
    lv_image_set_src(ui->screen_img_2, &_btn_list_play_RGB565A8_70x70);
    lv_image_set_pivot(ui->screen_img_2, 0,0);
    ...
    ui->screen_label_author_1 = lv_label_create(ui->screen_cont_list);
    ...
    ui->screen_label_music_1 = lv_label_create(ui->screen_cont_list);
    ...
    ui->screen_btn_8 = lv_button_create(ui->screen_cont_list);
    ...
    ui->screen_btn_7 = lv_button_create(ui->screen_cont_list);
    ...
    ui->screen_btn_6 = lv_button_create(ui->screen_cont_list);
    ...
    ui->screen_btn_5 = lv_button_create(ui->screen_cont_list);
    ...
    ui->screen_btn_4 = lv_button_create(ui->screen_cont_list);
    ...
    ui->screen_btn_3 = lv_button_create(ui->screen_cont_list);
    ...
    ui->screen_btn_2 = lv_button_create(ui->screen_cont_list);
    ...
    ui->screen_btn_1 = lv_button_create(ui->screen_cont_list);
    ...
    ui->screen_img_1 = lv_image_create(ui->screen_cont_list);
    lv_obj_set_pos(ui->screen_img_1, 0, 14);
    lv_obj_set_size(ui->screen_img_1, 70, 70);
    lv_obj_add_flag(ui->screen_img_1, LV_OBJ_FLAG_CLICKABLE);
    lv_image_set_src(ui->screen_img_1, &_btn_list_pause_RGB565A8_70x70);
    ...
    lv_obj_set_style_bg_grad_dir(ui->screen_player, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->screen_imgbtn_play = lv_imagebutton_create(ui->screen_player);
    lv_obj_set_pos(ui->screen_imgbtn_play, 145, 232);
    lv_obj_set_size(ui->screen_imgbtn_play, 100, 100);
    lv_obj_add_flag(ui->screen_imgbtn_play, LV_OBJ_FLAG_CHECKABLE);
    lv_imagebutton_set_src(ui->screen_imgbtn_play, LV_IMAGEBUTTON_STATE_RELEASED, &_btn_play_RGB565A8_100x100, NULL, NULL);
    lv_imagebutton_set_src(ui->screen_imgbtn_play, LV_IMAGEBUTTON_STATE_PRESSED, &_btn_play_RGB565A8_100x100, NULL, NULL);
    lv_imagebutton_set_src(ui->screen_imgbtn_play, LV_IMAGEBUTTON_STATE_CHECKED_RELEASED, &_btn_pause_RGB565A8_100x100, NULL, NULL);
    lv_imagebutton_set_src(ui->screen_imgbtn_play, LV_IMAGEBUTTON_STATE_CHECKED_PRESSED, &_btn_pause_RGB565A8_100x100, NULL, NULL);
    ...
    lv_obj_set_style_image_recolor_opa(ui->screen_imgbtn_play, 0, LV_PART_MAIN|LV_STATE_PRESSED);
    lv_obj_set_style_image_opa(ui->screen_imgbtn_play, 255, LV_PART_MAIN|LV_STATE_PRESSED);
    ...
    lv_obj_set_style_image_recolor_opa(ui->screen_imgbtn_play, 0, LV_PART_MAIN|LV_STATE_CHECKED);
    lv_obj_set_style_image_opa(ui->screen_imgbtn_play, 255, LV_PART_MAIN|LV_STATE_CHECKED);
    ...
    //Write style for screen_imgbtn_play, Part: LV_PART_MAIN, State: LV_IMAGEBUTTON_STATE_RELEASED.
    lv_obj_set_style_image_recolor_opa(ui->screen_imgbtn_play, 0, LV_PART_MAIN|LV_IMAGEBUTTON_STATE_RELEASED);
    lv_obj_set_style_image_opa(ui->screen_imgbtn_play, 255, LV_PART_MAIN|LV_IMAGEBUTTON_STATE_RELEASED);

    //Write codes screen_img_wave_bottom
    ui->screen_img_wave_bottom = lv_image_create(ui->screen_player);
    lv_obj_set_pos(ui->screen_img_wave_bottom, 0, 434);
    lv_obj_set_size(ui->screen_img_wave_bottom, 800, 35);
    lv_obj_add_flag(ui->screen_img_wave_bottom, LV_OBJ_FLAG_CLICKABLE);
    lv_image_set_src(ui->screen_img_wave_bottom, &_wave_bottom_RGB565A8_800x35);
    lv_image_set_pivot(ui->screen_img_wave_bottom, 0,0);
    lv_image_set_rotation(ui->screen_img_wave_bottom, 0);

    //Write style for screen_img_wave_bottom, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_image_recolor_opa(ui->screen_img_wave_bottom, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_image_opa(ui->screen_img_wave_bottom, 255, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_img_wave_top
    ui->screen_img_wave_top = lv_image_create(ui->screen_player);
    lv_obj_set_pos(ui->screen_img_wave_top, 0, 0);
    lv_obj_set_size(ui->screen_img_wave_top, 801, 35);
    lv_obj_add_flag(ui->screen_img_wave_top, LV_OBJ_FLAG_CLICKABLE);
    lv_image_set_src(ui->screen_img_wave_top, &_wave_top_RGB565A8_801x35);
    lv_image_set_pivot(ui->screen_img_wave_top, 0,0);
    lv_image_set_rotation(ui->screen_img_wave_top, 0);

    //Write style for screen_img_wave_top, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_image_recolor_opa(ui->screen_img_wave_top, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_image_opa(ui->screen_img_wave_top, 255, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_img_icn_rnd
    ui->screen_img_icn_rnd = lv_image_create(ui->screen_player);
    lv_obj_set_pos(ui->screen_img_icn_rnd, 26, 264);
    lv_obj_set_size(ui->screen_img_icn_rnd, 43, 43);
    lv_obj_add_flag(ui->screen_img_icn_rnd, LV_OBJ_FLAG_CLICKABLE);
    lv_image_set_src(ui->screen_img_icn_rnd, &_btn_rnd_RGB565A8_43x43);
    lv_image_set_pivot(ui->screen_img_icn_rnd, 0,0);
    lv_image_set_rotation(ui->screen_img_icn_rnd, 0);

    //Write style for screen_img_icn_rnd, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_image_recolor_opa(ui->screen_img_icn_rnd, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_image_opa(ui->screen_img_icn_rnd, 255, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_img_icn_loop
    ui->screen_img_icn_loop = lv_image_create(ui->screen_player);
    lv_obj_set_pos(ui->screen_img_icn_loop, 335, 262);
    lv_obj_set_size(ui->screen_img_icn_loop, 43, 43);
    lv_obj_add_flag(ui->screen_img_icn_loop, LV_OBJ_FLAG_CLICKABLE);
    lv_image_set_src(ui->screen_img_icn_loop, &_btn_loop_RGB565A8_43x43);
    lv_image_set_pivot(ui->screen_img_icn_loop, 0,0);
    lv_image_set_rotation(ui->screen_img_icn_loop, 0);

    //Write style for screen_img_icn_loop, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_image_recolor_opa(ui->screen_img_icn_loop, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_image_opa(ui->screen_img_icn_loop, 255, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_img_icn_left
    ui->screen_img_icn_left = lv_image_create(ui->screen_player);
    lv_obj_set_pos(ui->screen_img_icn_left, 76, 243);
    lv_obj_set_size(ui->screen_img_icn_left, 78, 78);
    lv_obj_add_flag(ui->screen_img_icn_left, LV_OBJ_FLAG_CLICKABLE);
    lv_image_set_src(ui->screen_img_icn_left, &_btn_prev_RGB565A8_78x78);
    lv_image_set_pivot(ui->screen_img_icn_left, 0,0);
    lv_image_set_rotation(ui->screen_img_icn_left, 0);

    //Write style for screen_img_icn_left, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_image_recolor_opa(ui->screen_img_icn_left, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_image_opa(ui->screen_img_icn_left, 255, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_img_icn_right
    ui->screen_img_icn_right = lv_image_create(ui->screen_player);
    lv_obj_set_pos(ui->screen_img_icn_right, 238, 243);
    lv_obj_set_size(ui->screen_img_icn_right, 78, 78);
    lv_obj_add_flag(ui->screen_img_icn_right, LV_OBJ_FLAG_CLICKABLE);
    lv_image_set_src(ui->screen_img_icn_right, &_btn_next_RGB565A8_78x78);
    lv_image_set_pivot(ui->screen_img_icn_right, 0,0);
    lv_image_set_rotation(ui->screen_img_icn_right, 0);

    //Write style for screen_img_icn_right, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_image_recolor_opa(ui->screen_img_icn_right, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_image_opa(ui->screen_img_icn_right, 255, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_slider_time
    ui->screen_slider_time = lv_slider_create(ui->screen_player);
    lv_obj_set_pos(ui->screen_slider_time, 18, 382);
    lv_obj_set_size(ui->screen_slider_time, 336, 5);
    lv_slider_set_range(ui->screen_slider_time, 0, 100);
    lv_slider_set_mode(ui->screen_slider_time, LV_SLIDER_MODE_NORMAL);
    lv_slider_set_value(ui->screen_slider_time, 0, LV_ANIM_OFF);

    //Write style for screen_slider_time, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->screen_slider_time, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_slider_time, lv_color_hex(0x7e888f), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->screen_slider_time, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_slider_time, 88, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_outline_width(ui->screen_slider_time, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_slider_time, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write style for screen_slider_time, Part: LV_PART_INDICATOR, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->screen_slider_time, 255, LV_PART_INDICATOR|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_slider_time, lv_color_hex(0x5691f8), LV_PART_INDICATOR|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->screen_slider_time, LV_GRAD_DIR_HOR, LV_PART_INDICATOR|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_color(ui->screen_slider_time, lv_color_hex(0xa666f1), LV_PART_INDICATOR|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_main_stop(ui->screen_slider_time, 0, LV_PART_INDICATOR|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_stop(ui->screen_slider_time, 255, LV_PART_INDICATOR|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_slider_time, 88, LV_PART_INDICATOR|LV_STATE_DEFAULT);

    //Write style for screen_slider_time, Part: LV_PART_KNOB, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->screen_slider_time, 0, LV_PART_KNOB|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_image_src(ui->screen_slider_time, &_icn_slider_RGB565A8_15x15, LV_PART_KNOB|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_image_opa(ui->screen_slider_time, 255, LV_PART_KNOB|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_image_recolor_opa(ui->screen_slider_time, 0, LV_PART_KNOB|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_slider_time, 3, LV_PART_KNOB|LV_STATE_DEFAULT);

    //Write codes screen_img_icn_msg
    ui->screen_img_icn_msg = lv_image_create(ui->screen_player);
    lv_obj_set_pos(ui->screen_img_icn_msg, 283, 141);
    lv_obj_set_size(ui->screen_img_icn_msg, 43, 43);
    lv_obj_add_flag(ui->screen_img_icn_msg, LV_OBJ_FLAG_CLICKABLE);
    lv_image_set_src(ui->screen_img_icn_msg, &_icn_chat_RGB565A8_43x43);
    lv_image_set_pivot(ui->screen_img_icn_msg, 0,0);
    lv_image_set_rotation(ui->screen_img_icn_msg, 0);

    //Write style for screen_img_icn_msg, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_image_recolor_opa(ui->screen_img_icn_msg, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_image_opa(ui->screen_img_icn_msg, 255, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_img_icn_heart
    ui->screen_img_icn_heart = lv_image_create(ui->screen_player);
    lv_obj_set_pos(ui->screen_img_icn_heart, 51, 142);
    lv_obj_set_size(ui->screen_img_icn_heart, 43, 43);
    lv_obj_add_flag(ui->screen_img_icn_heart, LV_OBJ_FLAG_CLICKABLE);
    lv_image_set_src(ui->screen_img_icn_heart, &_icn_heart_RGB565A8_43x43);
    lv_image_set_pivot(ui->screen_img_icn_heart, 0,0);
    lv_image_set_rotation(ui->screen_img_icn_heart, 0);

    //Write style for screen_img_icn_heart, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_image_recolor_opa(ui->screen_img_icn_heart, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_image_opa(ui->screen_img_icn_heart, 255, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_img_icn_donwload
    ui->screen_img_icn_donwload = lv_image_create(ui->screen_player);
    lv_obj_set_pos(ui->screen_img_icn_donwload, 208, 139);
    lv_obj_set_size(ui->screen_img_icn_donwload, 43, 43);
    lv_obj_add_flag(ui->screen_img_icn_donwload, LV_OBJ_FLAG_CLICKABLE);
    lv_image_set_src(ui->screen_img_icn_donwload, &_icn_download_RGB565A8_43x43);
    lv_image_set_pivot(ui->screen_img_icn_donwload, 0,0);
    lv_image_set_rotation(ui->screen_img_icn_donwload, 0);

    //Write style for screen_img_icn_donwload, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_image_recolor_opa(ui->screen_img_icn_donwload, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_image_opa(ui->screen_img_icn_donwload, 255, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_img_icn_chart
    ui->screen_img_icn_chart = lv_image_create(ui->screen_player);
    lv_obj_set_pos(ui->screen_img_icn_chart, 133, 142);
    lv_obj_set_size(ui->screen_img_icn_chart, 43, 43);
    lv_obj_add_flag(ui->screen_img_icn_chart, LV_OBJ_FLAG_CLICKABLE);
    lv_image_set_src(ui->screen_img_icn_chart, &_icn_chart_RGB565A8_43x43);
    lv_image_set_pivot(ui->screen_img_icn_chart, 0,0);
    lv_image_set_rotation(ui->screen_img_icn_chart, 0);

    //Write style for screen_img_icn_chart, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_image_recolor_opa(ui->screen_img_icn_chart, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_image_opa(ui->screen_img_icn_chart, 255, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_label_slider_time
    ui->screen_label_slider_time = lv_label_create(ui->screen_player);
    lv_obj_set_pos(ui->screen_label_slider_time, 363, 370);
    lv_obj_set_size(ui->screen_label_slider_time, 73, 30);
    ...
    lv_obj_set_style_text_color(ui->screen_label_slider_time, lv_color_hex(0x1a1a1a), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->screen_label_slider_time, &lv_font_montserratMedium_23, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->screen_label_slider_time, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->screen_label_slider_time, 1, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_label_title_music, 71, 47);
    lv_obj_set_size(ui->screen_label_title_music, 386, 47);
    ...
    lv_obj_set_style_text_color(ui->screen_label_title_music, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->screen_label_title_music, &lv_font_montserratMedium_30, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_align(ui->screen_label_title_music, LV_TEXT_ALIGN_LEFT, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_label_title_author, 135, 90);
    lv_obj_set_size(ui->screen_label_title_author, 301, 45);
    ...
    lv_obj_set_style_text_color(ui->screen_label_title_author, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->screen_label_title_author, &lv_font_montserratMedium_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_align(ui->screen_label_title_author, LV_TEXT_ALIGN_LEFT, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    //Write codes screen_cont_album
    ui->screen_cont_album = lv_obj_create(ui->screen_player);
    lv_obj_set_pos(ui->screen_cont_album, 373, 17);
    lv_obj_set_size(ui->screen_cont_album, 416, 416);
    lv_obj_set_scrollbar_mode(ui->screen_cont_album, LV_SCROLLBAR_MODE_OFF);

    //Write style for screen_cont_album, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->screen_cont_album, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_cont_album, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->screen_cont_album, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->screen_cont_album, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->screen_cont_album, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->screen_cont_album, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->screen_cont_album, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_cont_album, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_img_cover3
    ui->screen_img_cover3 = lv_image_create(ui->screen_cont_album);
    lv_obj_set_pos(ui->screen_img_cover3, 59, 59);
    lv_obj_set_size(ui->screen_img_cover3, 300, 300);
    lv_obj_add_flag(ui->screen_img_cover3, LV_OBJ_FLAG_HIDDEN);
    lv_obj_add_flag(ui->screen_img_cover3, LV_OBJ_FLAG_CLICKABLE);
    lv_image_set_src(ui->screen_img_cover3, &_cover_3_ARGB8888_300x300);
    lv_image_set_pivot(ui->screen_img_cover3, 0,0);
    lv_image_set_rotation(ui->screen_img_cover3, 0);

    //Write style for screen_img_cover3, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_image_recolor_opa(ui->screen_img_cover3, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_image_opa(ui->screen_img_cover3, 255, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_img_cover2
    ui->screen_img_cover2 = lv_image_create(ui->screen_cont_album);
    lv_obj_set_pos(ui->screen_img_cover2, 59, 59);
    lv_obj_set_size(ui->screen_img_cover2, 300, 300);
    lv_obj_add_flag(ui->screen_img_cover2, LV_OBJ_FLAG_HIDDEN);
    lv_obj_add_flag(ui->screen_img_cover2, LV_OBJ_FLAG_CLICKABLE);
    lv_image_set_src(ui->screen_img_cover2, &_cover_2_ARGB8888_300x300);
    lv_image_set_pivot(ui->screen_img_cover2, 0,0);
    lv_image_set_rotation(ui->screen_img_cover2, 0);

    //Write style for screen_img_cover2, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_image_recolor_opa(ui->screen_img_cover2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_image_opa(ui->screen_img_cover2, 255, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_img_album
    ui->screen_img_album = lv_image_create(ui->screen_cont_album);
    lv_obj_set_pos(ui->screen_img_album, 59, 59);
    lv_obj_set_size(ui->screen_img_album, 300, 300);
    lv_obj_add_flag(ui->screen_img_album, LV_OBJ_FLAG_CLICKABLE);
    lv_image_set_src(ui->screen_img_album, &_cover_1_ARGB8888_300x300);
    lv_image_set_pivot(ui->screen_img_album, 88,88);
    lv_image_set_rotation(ui->screen_img_album, 0);

    //Write style for screen_img_album, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_image_recolor_opa(ui->screen_img_album, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_image_opa(ui->screen_img_album, 255, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_label_tracks
    ui->screen_label_tracks = lv_label_create(ui->screen_player);
    lv_obj_set_pos(ui->screen_label_tracks, 391, 469);
    lv_obj_set_size(ui->screen_label_tracks, 40, 5);
    ...
    lv_obj_set_style_text_font(ui->screen_label_tracks, &lv_font_montserratMedium_25, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->screen_btn_tracks = lv_button_create(ui->screen_player);
    lv_obj_set_pos(ui->screen_btn_tracks, 335, 435);
    lv_obj_set_size(ui->screen_btn_tracks, 156, 33);
    ...
    lv_obj_set_style_text_font(ui->screen_btn_tracks, &lv_font_montserratMedium_21, LV_PART_MAIN|LV_STATE_DEFAULT);
