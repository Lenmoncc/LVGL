...
typedef struct
{
	...
	lv_obj_t *screen_cont_album;
	lv_obj_t *screen_img_cover3;
	lv_obj_t *screen_img_cover2;
...
LV_IMAGE_DECLARE(_btn_list_play_RGB565A8_70x70);
LV_IMAGE_DECLARE(_btn_play_RGB565A8_70x70);
LV_IMAGE_DECLARE(_btn_list_pause_RGB565A8_70x70);
LV_IMAGE_DECLARE(_btn_play_RGB565A8_100x100);
LV_IMAGE_DECLARE(_btn_pause_RGB565A8_100x100);
LV_IMAGE_DECLARE(_wave_bottom_RGB565A8_800x35);
LV_IMAGE_DECLARE(_wave_top_RGB565A8_801x35);
LV_IMAGE_DECLARE(_btn_rnd_RGB565A8_43x43);
LV_IMAGE_DECLARE(_btn_loop_RGB565A8_43x43);
LV_IMAGE_DECLARE(_btn_prev_RGB565A8_78x78);
LV_IMAGE_DECLARE(_btn_next_RGB565A8_78x78);

LV_IMAGE_DECLARE(_icn_slider_RGB565A8_15x15);
LV_IMAGE_DECLARE(_icn_chat_RGB565A8_43x43);
LV_IMAGE_DECLARE(_icn_heart_RGB565A8_43x43);
LV_IMAGE_DECLARE(_icn_download_RGB565A8_43x43);
LV_IMAGE_DECLARE(_icn_chart_RGB565A8_43x43);
LV_IMAGE_DECLARE(_cover_3_ARGB8888_300x300);
LV_IMAGE_DECLARE(_cover_2_ARGB8888_300x300);
LV_IMAGE_DECLARE(_cover_1_ARGB8888_300x300);
