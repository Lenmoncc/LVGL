...
static void screen_event_handler (lv_event_t *e)
{
    ...
    {
        lv_obj_remove_flag(guider_ui.screen_player, LV_OBJ_FLAG_SCROLLABLE | LV_OBJ_FLAG_IGNORE_LAYOUT);
        break;
    }
    default:
        break;
...
static void screen_btn_tracks_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_CLICKED:
    {
        if (lv_obj_get_y(guider_ui.screen_player) == 0) {
            ui_animation(guider_ui.screen_player, 1000, 0, lv_obj_get_y(guider_ui.screen_player), -435, &lv_anim_path_linear, 0, 0, 0, 0, (lv_anim_exec_xcb_t)lv_obj_set_y, NULL, NULL, NULL);
        } else {
            ui_animation(guider_ui.screen_player, 1000, 0, lv_obj_get_y(guider_ui.screen_player), 0, &lv_anim_path_linear, 0, 0, 0, 0, (lv_anim_exec_xcb_t)lv_obj_set_y, NULL, NULL, NULL);
        }
        break;
    }
    default:
